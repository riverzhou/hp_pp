...
int ppthread_image(int user_id, int bid_id)
{
	...
	if(err != 0) {
		fprintf(stderr, FUNC_NAME_HEAD"user_id=%d , bid_id=%d : proc_image error! \n", __func__, user_id, bid_id);
		LOGT1(FUNC_NAME_HEAD"user_id=%d , bid_id=%d : proc_image error! \n", __func__, user_id, bid_id);
	...
	if(err != 0) {
		fprintf(stderr, FUNC_NAME_HEAD"user_id=%d , bid_id=%d : proc_decode error! \n", __func__, user_id, bid_id);
		LOGT1(FUNC_NAME_HEAD"user_id=%d , bid_id=%d : proc_decode error! \n", __func__, user_id, bid_id);
		pp_user[user_id].price[bid_id] = 0;
		return -1;
	}
...
void ppthread_price(int user_id, int bid_id)
{
	...
	if(err != 0) {
		fprintf(stderr, FUNC_NAME_HEAD"user_id=%d , bid_id=%d : proc_price error! \n", __func__, user_id, bid_id);
		LOGT1(FUNC_NAME_HEAD"user_id=%d , bid_id=%d : proc_price error! \n", __func__, user_id, bid_id);
	}
}
